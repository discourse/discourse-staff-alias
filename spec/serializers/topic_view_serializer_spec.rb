  ...
  describe "#details" do
    describe "#staff_alias_can_create_post" do
      it "should be true when alias user is able to create a post in the topic" do
        ...
        payload =
          TopicViewSerializer.new(topic_view, scope: Guardian.new(moderator), root: false).as_json
      ...
      it "should be false when alias user is not able to create a post in the topic" do
        ...
        payload =
          TopicViewSerializer.new(topic_view, scope: Guardian.new(admin), root: false).as_json
